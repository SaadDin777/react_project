        ...
        <Box sx={{ display: 'flex' }}>
            ...
            position="fixed">
                <Toolbar sx={myStyles.toolbar}>
                    ...
                    <Typography variant="h6" noWrap>Hero Data</Typography>
                    ...
                    <Dialog open={dialogOpen} onClose={handleDialogClickClose} aria-labelledby="form-dialog-title">
                        ...
                        <DialogActions>
                            <Button onClick = {handleDialogClickClose} color="success">Cancel</Button>
                        </DialogActions>
                    </Dialog>
                </Toolbar>
            </AppBar>
            ...
            <Box sx={myStyles.content} >
                ...
                <h1>Hello Humans, Welcome to the Data Page</h1>
                <DataTable />
